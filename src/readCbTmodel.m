...
%
%EXAMPLE INPUTS
% iBSU1103 = readCbTmodel('iBSU1103',Tmodel)
%
%INPUTS
...
%               emtyArrayChoice: "y" or "n" to remove empty arrays or not
%
%OUTPUTS        
...
if nargin > 1
    Tmodel = varargin{1};
    if nargin > 2
        emptyArrayChoice = varargin{2} ;
    end
else
    load('~/techdata/Bioinformatics/modeling/models/Tmodel.mat') ; 
end
