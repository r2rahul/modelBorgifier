...
%
%OPTIONAL INPUTS
% Tmodel    Template model. In COBRA format. If no Tmodel is provided one
...
% score     Every individual score, spli by number of comparison factors.
%           Size = MxNxF
...
for iRxn = 1:nRxns
    ...
    % toatl stoich, product number, product total stoich.
